...
import TodoListMenu from '/@components/todo/TodoListMenu.vue'
...
export default {
	...
	setup(props) {
		...
		const filters = {
			...
			3 : {str: '모든 작업', func: getAllTodos, category: false}
		}
		...
		watch(
			...
			([new_filter, new_todos], [old_filter, old_todos]) => {
				console.log('Watch out!!!', new_filter, old_filter)
...
<template>
	...
	<div class="my-2 mt-5" style="display:flex">
